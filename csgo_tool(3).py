        ...
        try:
            ...
            for i in range(MAX_ENTITIES):
                try:
                    ...
                    bx1, bx2  = x1-8, x1-3
                    canvas.create_rectangle(bx1, y1,          bx2, y2, fill=NORD["bg_hover"], outline=NORD["bg_light"])
                    ...
                    try:
                        ...
                        name = "?"
                    canvas.create_text(fx+1, y1-14, text=name, fill=NORD["bg"], font=("Arial", 10, "bold"))
                    canvas.create_text(fx, y1-15, text=name, fill=NORD["fg_bright"], font=("Arial", 10, "bold"))
            ...
            if shared["fov_circle"]:
                radius = int((sw / 2) * math.tan(math.radians(shared["desired_fov"]))
